...
def train_baseline():
    """Entraînement baseline sans curriculum learning - SANS early stopping"""
    print("\n📊 Entraînement Baseline (sans curriculum et sans early stopping)")
    ...
    for epoch in range(1, num_epochs_total + 1):
        ...
        # Sauvegarder seulement le meilleur modèle, pas d'early stopping
        if val_acc > best_val_acc:
            best_val_acc = val_acc
    ...
    print(f"✅ Baseline terminé - Meilleure val accuracy: {best_val_acc:.4f}")
    return model, history
